 ...
 */
function ZigbeeDevice(ProfileId, DeviceId, NetworkAddr, EndPoint) {
...
ZigbeeDevice.prototype.setDeviceColour = function(hue, saturation, transitionTime) {
    ...
    console.log('ZigbeeDevice.prototype.setDeviceColour++');
    ...
    console.log('ZigbeeDevice.prototype.setDeviceColour: ' + hue + '-' + saturation);
...
ZigbeeDevice.prototype.setDeviceLevel = function(level, transitionTime) {
    ...
    console.log('ZigbeeDevice.setDeviceLevel.setDeviceColour++');
    ...
    console.log('ZigbeeDevice.prototype.setDeviceLevel: ' +level);
...
ZigbeeDevice.prototype.setDeviceState = function(state) {
    ...
    console.log('ZigbeeDevice.prototype.setDeviceState++');
    ...
    console.log('ZigbeeDevice.prototype.setDeviceState: ' +state);
