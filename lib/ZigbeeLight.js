...
util.inherits(ZigbeeLight,Stream);
 ...
 */
function ZigbeeLight(logger, ProfileId, DeviceId, NetworkAddr, EndPoint) {
  ...
  else if(ProfileId == 0x0104) //ZLL
  {
    switch (DeviceId)
    {
      case (0x0000):
      {
        Type = "On/Off Switch";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "On/Off Switch";
        break;
      }
      case (0x0001):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Level Control Switch";
        break;
      }
      case (0x0002):
      {
        Type = "On/Off Output";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "On/Off Output";
        break;
      }
      case (0x0003):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Level Controllable Output";
        break;
      }
      case (0x0004):
      {
        Type = "Scene Selector";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Scene Selector";
        break;
      }
      case (0x0005):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Configuration Tool";
        break;
      }
      case (0x0006):
      {
        Type = "Remote Control";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Remote Control";
        break;
      }
      case (0x0007):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Combined Interface";
        break;
      }
      case (0x0008):
      {
        Type = "Range Extender";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Range Extender";
        break;
      }
      case (0x0009):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Mains Power Outlet";
        break;
      }
      case (0x000A):
      {
        Type = "Door Lock";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Door Lock";
        break;
      }
      case (0x000B):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Door Lock Controller";
        break;
      }
      case (0x000C):
      {
        Type = "Simple Sensor";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Simple Sensor";
        break;
      }
      case (0x000D):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Consumption Awareness Device";
        break;
      }
      case (0x0050):
      {
        Type = "Home Gateway";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Home Gateway";
        break;
      }
      case (0x0051):
      {
        Type = "Smart plug";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Smart plug";
        break;
      }
      case (0x0052):
      {
        Type = "White Goods";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "White Goods";
        break;
      }
      case (0x0053):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Meter Interface";
        break;
      }
      case (0x0100):
      {
        Type = "On/Off Light";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "On/Off Light";
        break;
      }
      case (0x0101):
      {
        Type = "Dimmable Light";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Dimmable Light";
        break;
      }
      case (0x0102):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Color Dimmable Light";
        break;
      }
      case (0x0103):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "On/Off Light Switch";
        break;
      }
      case (0x0104):
      {
        Type = "Dimmer Switch";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Dimmer Switch";
        break;
      }
      case (0x0105):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Color Dimmer Switch";
        break;
      }
      case (0x0106):
      {
        Type = "Light Sensor";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Light Sensor";
        break;
      }
      case (0x0107):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Occupancy Sensor";
        break;
      }
      case (0x0200):
      {
      ...
      case (0x0201):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Shade Controller";
        break;
      }
      case (0x0202):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Window Covering Device";
        break;
      }
      case (0x0203):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Window Covering Controller";
        break;
      }
      case (0x0300):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Heating/Cooling Unit";
        break;
      }
    case (0x0301):
      {
        Type = "Thermostat";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Thermostat";
        break;
      }
    case (0x0302):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Temperature Sensor";
        break;
      }
    case (0x0303):
      {
    ...
    case (0x0304):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Pump Controller";
        break;
      }
    case (0x0305):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Pressure Sensor";
        break;
      }
    case (0x0306):
      {
        Type = "Flow Sensor";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Flow Sensor";
        break;
      }
    case (0x0307):
      {
        Type = "Mini Split AC";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "Mini Split AC";
        break;
      }
    case (0x0400):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "IAS Control and Indicating Equipment ";
        break;
      }
    case (0x0401):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "IAS Ancillary Control Equipment";
        break;
      }
    case (0x0402):
      {
        Type = "IAS Zone";
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "IAS Zone";
        break;
      }
    case (0x0403):
      {
        ...
        //set a default name that can be renamed later and stored in the hub
        Name= (ZigbeeLightIdx+1) + ": " + "IAS Warning Device";
        break;
      }
    default:
    {
 ...
 */
ZigbeeLight.prototype.write = function(data) {
 ...
 * @fires ZigbeeClient#state state of te device
 */
ZigbeeLight.prototype.processData = function(msg, msgPtr) {

  var msgLen=0;

  this.log.info('ZigbeeLight.prototype.processData: '+msg[msgPtr + SRPC_CMD_ID_POS]);
  switch (msg[msgPtr + SRPC_CMD_ID_POS]) {

    case RPCS_GET_DEV_LEVEL_RSP:

      var device = helpers.parseDeviceInformation(msg,msgPtr);

      msgPtr = device.msgPtr; // Hack to continue reading
      msgLen = device.msgLen; // Hack to continue reading

      // Check whether the data on the socket applies to us
      if (device.endPoint === this.EndPoint && device.nwkAddr === this.NetworkAddr) {

        console.log('Received',msg,'from',device)
        this.emit('state',{ level:1 })
      }
      break;
 ...
 * @fires ZigbeeLight#data       `data` written to SRPC client
 */
ZigbeeLight.prototype.getDeviceLevel = function() {
  var msg = new Buffer(18);
  var msgIdx;

  this.log.info('ZigbeeLight.prototype.getDeviceLevel++');
  ...
  this.emit('data',msg); // Emit down to the socket
};
 ...
 * @fires ZigbeeLight#data       `data` written to SRPC client
 */
ZigbeeLight.prototype.setDeviceColour = function(hue, saturation, transitionTime) {
  var msg = new Buffer(18);
  var msgIdx;

  this.log.debug('ZigbeeLight.prototype.setDeviceColour++');
  ...
  this.log.debug('ZigbeeLight.prototype.setDeviceColour: ' + hue + '-' + saturation);
 ...
 * @fires ZigbeeLight#data       `data` written to SRPC client
 */
ZigbeeLight.prototype.setDeviceLevel = function(level, transitionTime) {
  var msg = new Buffer(17);
  var msgIdx;

  this.log.debug('ZigbeeLight.setDeviceLevel.setDeviceColour++');
  ...
  this.log.debug('ZigbeeLight.prototype.setDeviceLevel: ' +level);
 ...
 * @fires ZigbeeLight#data       `data` written to SRPC client
 */
ZigbeeLight.prototype.setDeviceState = function(state) {
  var msg = new Buffer(15);
  var msgIdx;

  this.log.debug('ZigbeeLight.prototype.setDeviceState++');
  ...
  this.log.debug('ZigbeeLight.prototype.setDeviceState: ' +state);
