 ...
 * @fires ZigbeeClient#device instance of ZigbeeLight on new device found.
 */
ZigbeeLight.prototype.processData = function(msg, msgPtr) {
  ...
  switch (msg[msgPtr + SRPC_CMD_ID_POS]) {
    ...
    case RPCS_GET_DEV_STATE:
    case RPCS_GET_DEV_LEVEL:
    case RPCS_GET_DEV_HUE:
    case RPCS_GET_DEV_SAT:

        console.log('Received',msg,'State',msg[msgPtr + SRPC_CMD_ID_POS])
        break;
