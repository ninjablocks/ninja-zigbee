...
ZigBeeClient.prototype.processData = function(msg, msgPtr) {
  ...
  console.log('ZigBeeClient.prototype.processData: '+msg[msgPtr + SRPC_CMD_ID_POS]);
  switch (msg[msgPtr + SRPC_CMD_ID_POS]) {
    ...
    case RPCS_NEW_ZLL_DEVICE:
      ...
      console.log('ZigBeeClient.prototype.processData: nwkAddr ' +nwkAddr);
      
      //Get the EndPoint
      endPoint = msg[msgPtr++];
      console.log('ZigBeeClient.prototype.processData: endPoint ' +endPoint);
      ...
      console.log('ZigBeeClient.prototype.processData: profileId ' +profileId);
      ...
      console.log('ZigBeeClient.prototype.processData: deviceId ' +deviceId);


      // A new device has been found
      var device = new ZigbeeDevice(profileId, deviceId, nwkAddr, endPoint);
