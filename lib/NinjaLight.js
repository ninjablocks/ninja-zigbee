...
function NinjaLight(logger,device) {
  ...
  this.log.info('Creating NinjaLight: ' +device.type +' ' +device.nwkAddr +':' +device.endPoint );
...
NinjaLight.prototype.setDeviceState = function(state) {
  ...
  this.log.info('zigbee.prototype.setDeviceState++: nwk:' +this.zigbee.nwkAddr +' ep:' +this.zigbee.endPoint);
